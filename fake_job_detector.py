...
class FakeJobDetector:
    def __init__(self, dataset_path=None):
        ...
        """
        self.pipeline = None
        self.dataset_path = r"fake_job_postings.csv"
        
        if dataset_path:
            # Load the dataset
            self.df = pd.read_csv(r"fake_job_postings.csv")
    ...
    def load_model(self, filepath):
        ...
        print("Model loaded successfully from fake_job_detector.pkl")
...
if __name__ == "__main__":
    ...
    dataset_path = r"fake_job_postings.csv"
    
    # Create and train model
    model = FakeJobDetector(r"fake_job_postings.csv")
